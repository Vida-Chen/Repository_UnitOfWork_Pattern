...
{
	public class RepositoryTransaction<T> : IRepository<T> where T : class
	{
		private UnitOfWork unitOfWork;
		private DBHelper dbSelector;
		private StringBuilder strSql;

		public RepositoryTransaction(IUnitOfWork unitOfWork)
		{
			dbSelector = new DBHelper();
			this.unitOfWork = (UnitOfWork)unitOfWork;
			strSql = new StringBuilder();
		}
		private SQLiteTransaction _Transaction { get { return unitOfWork.transaction; } }
		private SQLiteConnection _Connection { get { return unitOfWork.connection; } }
		public void Delete(T entity)
		{
			...
			try
			{
				...
				//{
				//	cn.Open();
				SQLiteCommand cmd = new SQLiteCommand(strSql.ToString(), _Connection);
